...
_STRINGS: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        "adb_status.not_found": "請確認手機已用 USB 連接電腦，並開啟「USB 偵錯」。",
        "adb_status.unauthorized": "請在手機上點擊「允許 USB 偵錯」的授權對話框。",
    ...
    "en": {
        ...
        "adb_status.not_found": "Please make sure your phone is connected via USB and “USB debugging” is enabled.",
        "adb_status.unauthorized": "Please tap “Allow USB debugging” on the authorization dialog on your phone.",
